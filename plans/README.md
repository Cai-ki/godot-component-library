# Component Library — Future Plans
...
1. **D2 基础组件** — 补齐常见组件，提升库的完整度
2. **D4 Scenes** — 更多实际场景，展示组合能力
3. **D3 数据展示** — `_draw()` 图表是亮点，差异化竞争力
4. **D5 基础设施** — 动画 / 响应式提升体验
5. **D6 开发者工具** — Playground 对使用者价值高但开发量大
